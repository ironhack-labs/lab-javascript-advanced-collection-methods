...
//LAST SONG RECORDED IN THE 1960s

var songsFromThe60s = _.filter(abbeyRoadRecords, function(record){return record.year>=1960 && record.year<1970;});
//console.log(songsFromThe60s);

var songsFrom1969 = _.filter(songsFromThe60s, function(record){return record.year===1969;});
console.log(songsFrom1969);

var lastSong = _.maxBy(songsFrom1969, function(record) {return record.month;});
console.log(lastSong.song);


/*
//LAST BEATLES RECORD DATE
var beatlesRecords = _.filter(abbeyRoadRecords, function(record){return record.artist === "The Beatles";});
//console.log(beatlesRecords);

var lastRecord = _.maxBy(beatlesRecords, function(record){return record.year;});
console.log(lastRecord.year);
*/

/*
//ARTIST WHO RECORDED MOST AT ABBEY ROAD

var artistCount = _.countBy(abbeyRoadRecords, function(record){return record.artist;});
console.log(artistCount);

var artistArray = _.toPairs(artistCount);
console.log(artistArray);

var winningArtist = _.maxBy(artistArray, function(pair){return pair[1];})[0];
console.log(winningArtist);
*/
...
var novemberRecords = _.filter(abbeyRoadRecords, function(record){return record.month===11;})
console.log(novemberRecords);

var novemberArtists = _.countBy(novemberRecords, function(record){return record.artist});
console.log(novemberArtists);

var novemberArray = _.toPairs(novemberArtists);
console.log(novemberArray);
