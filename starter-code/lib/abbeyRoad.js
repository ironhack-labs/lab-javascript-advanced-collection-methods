...
var novemberArtists = abbeyRoadRecords.filter(function(el) {
  return (el.month === 11);
});

function countArtist(arrayAbbey) {
  return arrayAbbey.reduce(function(prev, next) {
    prev[next.artist] = (prev[next.artist] + 1) || 1;
    return prev;
  }, {});
}
