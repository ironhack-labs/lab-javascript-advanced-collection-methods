...
//EJ_1
function novemberArtists(a) {
  var month = _.filter(a, {'month': 11});
  var numArtist = _.countBy(month, 'artist')

  var values = _.values(numArtist);
  var max = _.maxBy(values);
  var index = _.indexOf(values, max);
  var keys = _.keys(numArtist);
