...
var november = abbeyRoadRecords.filter(function(record){
return record.month == 11;
});
  //your code
var namesNov = november.map(function(element){
...
var names = abbeyRoadRecords.map(function(element){
return element.artist;
});

function orderAbbeyArtist(arr){
...
var abbeyOrder = orderAbbeyArtist(names);
return abbeyOrder[0];
...
var lastBeatlesSong = function () {
  //your code
  var beatles = abbeyRoadRecords.filter(function(song){
      return song.artist === "The Beatles";
  });

   var songs = beatles.map(function(element){
      return element.song;
    });
  var years = beatles.map(function(element){
      return element.year;
    });
...
var sixties = abbeyRoadRecords.filter(function(song){
  return song.year >= 1960 && song.year < 1970;
});

var lastSongYear = sixties.sort(function(a,b){
