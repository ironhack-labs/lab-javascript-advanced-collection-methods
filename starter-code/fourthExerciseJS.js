...
var arrayFilteredNovember = abbeyRoadRecords.filter(function(element){
  return (element.year >1929 && element.year <1940 && element.month === 11);
});
//It contains the name of the artists who had songs in november
var arrayArtists = arrayFilteredNovember.map(function(element){
  return element.artist;
});

arrayArtists = _.uniq(arrayArtists);

arrayArtists.forEach(function(element){
  console.log(element);
});
