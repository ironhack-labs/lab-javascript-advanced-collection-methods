...
function randomOpinion() {
  return opinions[_.random(0,opinions.length - 1)];
}

var random = randomOpinion();
...
function nestedBirthdays(array) {
  return _.chunk(array,2);
}

var originalBirthdays = nestedBirthdays(birthdays);

var moreBirthdays = nestedBirthdays(["Lily Evans", "30 January", "James Potter", "27 March","Dudley Dursley", "30 June", "Tom Riddle", "31 December"]);

function allBirthdays(array1,array2){
  return _.unionBy(array1,array2);
}

console.log(allBirthdays(originalBirthdays,moreBirthdays));
...
console.log(noRepeatChar(requestPassword()));
...
var trimPassword = function (password) {
  var newArray = _.slice(password,0,10);
...
function namesArtistsMonth(array){
  var newarray=_.filter(array, _.matches({ 'month' : 11}));
  return newarray
  }

console.log(namesArtistsMonth(abbeyRoadRecords));
console.log(_.uniqBy(abbeyRoadRecords,'name'));
