//Create an array with the 5 set answers of a work satisfaction survey. 5 questions; 5 departments; 10 people in each department.
...
//Note this (employeeSatisfaction function) is the final step of the employee survey exercise.
...
//Create a function that pushes the item into the array. 10x
...
//Create another function that pushes the 10-items-array into another array. 5x
function department() {
  var finalArray = [];
...
var birthdays = ["Severus Snape", "9 January", "Arthur Weasley", "6 February",
  ...
  var newArray =[];
  function organizeNames(birthdays){

      var chunk = lodash.chunk(birthdays, 2);
      newArray.push(chunk);
      return newArray;
  };

  //add additional birthdays just discovered****************************

  var moreBirthdays = ["Lily Evans", "30 January", "James Potter", "27 March",
                     "Dudley Dursley", "30 June", "Tom Riddle", "31 December"];

  function addNames(){
    var addedNames = birthdays + lodash.chunk(moreBirthdays,2);
    newArray.push(addedNames)
    return newArray;
  }

  /*var addedNames = birthdays.concat(moreBirthdays);
  function finalArray(){
    return lodash.chunk(addedNames,2);
  }; */
...
var noRepeatChar = function(password) {
  var uniquePassword = lodash.uniq(password);
...
// Create a function that receives a password and returns an error if the password has any character different than numbers.

var goodPsswd = "1234567890";
var badPsswd = "1a234567890";

var onlyNumbers = function (password) {
 var checkPassword = lodash.times(password.length-1, function(){
   return password.match(/[a-z]/g) ? "Password not good" : "Password good";
 });
  if (lodash.includes(checkPassword, "Password not good")) {
  console.log("Error! The password: "+password+" is not valid");
} else {
...
//Create a function that trim the password and turns it into a 10 digits password. The function should keep the first 10 digits and discard the rest of them.

var goodPsswd = "1234567890";
var badPsswd = "12345678901234567890";

var trimPassword = function (password) {
 var newPassword = lodash.slice(password, 0, 10);
 return newPassword;
}
trimPassword(badPsswd);


//****************************** ITERATION 4: ABBEY ROAD *******************
...
var novemberArtists = function () {
  ...
  var artist = lodash.filter(abbeyRoadRecords, {'month': 11});
  return artist;
};
novemberArtists();
